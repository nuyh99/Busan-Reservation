...
class MemberTest {
    ...
    void validateRegion() {
        assertThatThrownBy(() -> new Member("test@naver.com", "name", "passwordpasswo", null, "01012345678", "company", passwordEncoder))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void validateCompany() {
        assertThatThrownBy(() -> new Member("test@naver.com", "name", "passwordpasswo", GANGNEUNG, "01012345678", null, passwordEncoder))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void validatePhone() {
        assertThatThrownBy(() -> new Member("test@naver.com", "name", "passwordpasswo", GANGNEUNG, null, "company", passwordEncoder))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void validateName() {
        assertThatThrownBy(() -> new Member("test@naver.com", null, "passwordpasswo", GANGNEUNG, "01012345678", "company", passwordEncoder))
                .isInstanceOf(IllegalArgumentException.class);
    }
