...
class RoomControllerTest extends ApiTest {
    ...
    void findAll() throws Exception {
        //given
        final ReservationResponse reservation1 = new ReservationResponse(1L, LocalTime.of(13, 0), LocalTime.of(16, 0), true, Status.CANCELED, "우형", "연어");
        final ReservationResponse reservation2 = new ReservationResponse(2L, LocalTime.of(16, 0), LocalTime.of(17, 0), false, Status.RESERVED, "카카오", "참치");
        ...
        final MockHttpServletResponse response = mockMvc.perform(
                ...
                .andDo(document("회의실 전체 조회하기",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("[].reservations.[].reservedName").description("예약자명"),
